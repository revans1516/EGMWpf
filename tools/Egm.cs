...
namespace abb.egm {
      ...
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_abb_egm_EgmRobot__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::abb.egm.EgmRobot, global::abb.egm.EgmRobot.Builder>(internal__static_abb_egm_EgmRobot__Descriptor,
                new string[] { "Header", "FeedBack", "Planned", "MotorState", "MciState", "MciConvergenceMet", "TestSignals", "RapidExecState", "MeasuredForce", "UtilizationRate", });
  ...
  public sealed partial class EgmRobot : pb::GeneratedMessage<EgmRobot, EgmRobot.Builder> {
    ...
    private static readonly string[] _egmRobotFieldNames = new string[] { "feedBack", "header", "mciConvergenceMet", "mciState", "measuredForce", "motorState", "planned", "rapidExecState", "testSignals", "utilizationRate" };
    private static readonly uint[] _egmRobotFieldTags = new uint[] { 18, 10, 48, 42, 74, 34, 26, 66, 58, 81 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasUtilizationRate) {
        output.WriteDouble(10, field_names[9], UtilizationRate);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasUtilizationRate) {
        size += pb::CodedOutputStream.ComputeDoubleSize(10, UtilizationRate);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<EgmRobot, Builder> {
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 81: {
              result.hasUtilizationRate = input.ReadDouble(ref result.utilizationRate_);
              break;
            }
          }
        }
      ...
      public bool HasUtilizationRate {
        get { return result.hasUtilizationRate; }
      }
      public double UtilizationRate {
        get { return result.UtilizationRate; }
        set { SetUtilizationRate(value); }
      }
      public Builder SetUtilizationRate(double value) {
        PrepareBuilder();
        result.hasUtilizationRate = true;
        result.utilizationRate_ = value;
        return this;
      }
      public Builder ClearUtilizationRate() {
        PrepareBuilder();
        result.hasUtilizationRate = false;
        result.utilizationRate_ = 0D;
        return this;
      }
    }
    static EgmRobot() {
